...
<div class='main'>
	<section class='dan-hero' data-image-src='<?php bloginfo('template_url'); ?>/images/dan.png' data-parallax='scroll'>
		<div class='container'>
			<div class='row'>
	...
	<section class='surf hidden-xs' data-image-src='<?php bloginfo('template_url'); ?>/images/surf.png' data-parallax='scroll'></section>
	...
	<section class='ski hidden-xs' data-image-src='<?php the_field('dan_ski_image');?>' data-parallax='scroll'></section>
	<div class='visible-xs'>
